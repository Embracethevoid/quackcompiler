 ...
 * The receiver object ('it' in Quack) is an implicit argument 
...
typedef struct obj_String_struct {
  class_String clazz;
  char *text;     /* FIXME: Make it a garbage-collectable rope */ 
} * obj_String;
 ...
 * it is not available to the Quack programmer, but 
