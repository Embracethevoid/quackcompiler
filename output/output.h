...
obj_ temp46 = new_thing->m_ll->clazz->_x(obj_Square this);

obj_ temp47 = temp46->clazz->PLUS(temp46,side);

obj_ temp48 = new_thing->m_ll->clazz->_y(obj_Square this);

obj_ temp49 = temp48->clazz->PLUS(temp48,side);

obj_Pt temp45 = Pt_literal(temp47 , temp49);
new_thing->m_ur = temp45;
return new_Square;
}
